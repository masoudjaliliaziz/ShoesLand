  ...
  return (
    <>
      ...
      {count == 2 && <>
        ...
        <div onClick={nextPage} className='bg-[url("img/welcombanner.png")] h-screen bg-cover bg-no-repeat w-[428px] h-[100vh] flex flex-col items-start justify-end '>
      ...
      {count == 3 &&
        <>
          <div className='w-[428px] flex flex-col justify-start h-screen items-center gap-8 mt-0'>
            <div className='mt-[-60%]'>
              <img onClick={prevPage} src="img/back-w.png" className=' px-4 mx-4 top-[1%] cursor-pointer' alt="" />
          ...
          <div className='w-[428px] flex flex-col justify-start items-center gap-8 mt-0'>
            ...
            <div>
              <span className='text-black text-4xl
                font-bold'>Your satisfaction is our number one periority</span>
            </div>
            <div>
      ...
      {count == 5 &&
        <>
          <div className='w-[428px] flex flex-col justify-start items-center gap-8 mt-0'>
            <div className='mt-[-60%]'>
              <img onClick={prevPage} src="img/back-w.png" className=' px-4 mx-4 top-[1%] w-[60px] cursor-pointer' alt="" />
