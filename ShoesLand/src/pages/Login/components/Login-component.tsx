  ...
  return (
    <div className="flex flex-col h-screen px-5 w-full relative ">
      ...
      <div className="flex flex-col justify-center items-center gap-6 h-1/3 ">
        ...
        <span className="text-3xl font-bold pb-9 text-center text-black">Login to Your Account</span>
      <form onSubmit={handleSubmit(onSubmit)} className="">
        ...
        <p className="text-rose-500 font-semibold text-sm px-3">{errors.password?.message}</p>
        <div className="flex justify-between font-semibold text-sm px-1">
          <div className="space-x-1">
            <input type="checkbox" name="rememberme" id="rememberme" className="text-white rounded-full accent-slate-950"/>
